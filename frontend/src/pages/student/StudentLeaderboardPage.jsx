  ...
  const columns = [
    {
      ...
      accessor: 'rank',
      render: (r) => (
        <span className={`font-extrabold ${r.isCurrentUser ? 'text-brand-cyan text-base' : 'text-slate-300'}`}>
          #{r.rank}
        </span>
      ),
    },
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-bold text-slate-100 flex items-center gap-2">
              {r.name}
              {r.isCurrentUser && <Badge variant="cyan" size="sm">YOU</Badge>}
            </span>
          </div>
        </div>
      ),
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      <Header
        ...
        subtitle="Compare your progress against fellow platform learners."
      />
